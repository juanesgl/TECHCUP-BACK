...
public class UserServiceImpl implements UserService {
    ...
    private static final Set<String> ROLES_NO_JUGADOR = Set.of(
            "ORGANIZER", "REFEREE", "ADMINISTRATOR", "ADMIN",
    ...
    public RegisterResponseDTO registerUser(RegisterRequestDTO request) {
        ...
        String preferredPosition = (request.getPreferredPosition() != null
                && !request.getPreferredPosition().isBlank())
                ? request.getPreferredPosition()
                : (esNoJugador ? "N/A" : "DELANTERO");
