...
/**
 * Mapper entre TeamLineupEntity (persistencia) y TeamLineup (dominio).
 * No usa MapStruct porque TeamLineup tiene lógica de conversión
 * de reserveIds (String CSV ↔ List<Long>).
 */
@Component
